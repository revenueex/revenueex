...
export class RevenueTrendComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    var tavg = [52, 52, 57, 62, 69, 62, 62, 63, 61, 66, 70, 76, 64, 61, 62, 64, 71, 63, 66, 62, 57, 67, 60, 64, 76, 68, 68, 69, 72, 70, 71];

    var markerRange = [];
    let startOfMonth: Date = new Date();
    let dayOfMonth = startOfMonth.getDate();
